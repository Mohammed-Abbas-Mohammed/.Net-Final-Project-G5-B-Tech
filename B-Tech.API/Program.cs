    ...
    public class Program
    {
        public static void Main(string[] args)
        {
          ...
          options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
            ...
            //        builder => 
            //        {
            //            builder.AllowAnyOrigin()//*WithOrigins("http://127.0.0.1:5500") // Your Angular app's URL
            //                   .AllowAnyMethod()
            //                   .AllowAnyHeader()
            //                   .AllowCredentials(); // If you need to allow credentials (e.g., cookies, authorization headers)
            //        });
            //});
